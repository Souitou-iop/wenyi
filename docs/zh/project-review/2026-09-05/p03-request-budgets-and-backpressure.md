...
状态更新（2026-09-17）：部分实现。共享请求限额、调用／Token 预算、截止时间与取消已有实现，现行行为见[配置说明](../../configuration.md)。保留后续阶段预估及 embedding／重排等独立用量设计。下文是 2026-09-05 的历史基线和原方案，不代表当前缺失功能清单，工期需重新评估。
