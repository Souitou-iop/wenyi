...
_LOOSE_MARKER_ATTR = "data-tn-loose"
...
def _translation_targets(
    ...
    *,
    ...
    for element in soup.find_all(
        lambda tag: tag.name in _BLOCK_CANDIDATE_TAGS or tag.has_attr(_LOOSE_MARKER_ATTR)
    ):
...
def annotate_epub_resource(
    ...
    *,
    ...
    for el in _translation_targets(soup, skip_navigation=skip_navigation):
        ...
        if not text:
            continue
        el.attrs.pop(_LOOSE_MARKER_ATTR, None)
