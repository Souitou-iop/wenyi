...
from wenyi_core.assemble.writer_common import _epub_lang
from wenyi_core.config import Config
from wenyi_core.i18n.languages import (
    normalize_language,
    profile,
    supported_languages,
...
def test_every_profile_renders_all_tasks_without_missing_fields(target):
    root = Path(__file__).resolve().parents[1] / "wenyi_core/i18n/data/tasks"
